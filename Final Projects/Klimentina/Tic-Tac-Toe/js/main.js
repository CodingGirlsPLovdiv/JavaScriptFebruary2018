...
var gameEnded = false;
var winner = 0;
// if no one wins winner will be 0
//if the first player (playing with 'x') wins the value of winner will be 1
// if the second player (playing with 'o') wins the value will be 2
